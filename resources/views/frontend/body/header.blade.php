...
$setting = App\Models\SiteSetting::find(1);
    ...
    <div class="header-right">
     ...
     <div class="header-action-icon-2">
        ...
        <a href="{{url('compare') }}"><span class="lable ml-0">Compare</span></a>
    </div>
                ...
                <div class="header-action-icon-2">
                    <a class="mini-cart-icon" href="{{url('mycart') }}">
                        <img alt="Nest" src="{{ asset('frontend/assets/imgs/theme/icons/icon-cart.svg') }}" />
                        <span class="pro-count blue" id="cartQty"> </span>
                    </a>
                    <a href="{{url('mycart') }}"><span class="lable">Cart</span></a>
          ...
          <!--   // End mini cart start with ajax -->
                        ...
                        <div class="shopping-cart-footer">
                            ...
                            <div class="shopping-cart-button">
                                ...
                                <div class="header-action-icon-2">
                                    <a href="{{ url('/user/account/page') }}">
                                        <img class="svgInject" alt="Nest" src="{{ asset('frontend/assets/imgs/theme/icons/icon-user.svg') }}" />
                                    </a>

                                  
    @auth
    <a href="{{ url('/user/account/page') }}"><span class="lable ml-0">Account</span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
            <ul>
                <li>
                    <a href="{{ url('/user/account/page') }}"><i class="fi fi-rs-user mr-10"></i>My Account</a>
                </li>
                <li>
                    <a href="{{url('/user/account/page') }}"><i class="fi fi-rs-location-alt mr-10"></i>Order Tracking</a>
                </li>
                <li>
                    <a href="{{ url('dashboard') }}"><i class="fi fi-rs-label mr-10"></i>My Voucher</a>
                </li>
                <li>
                    <a href="{{url('dashboard') }}"><i class="fi fi-rs-heart mr-10"></i>My Wishlist</a>
                </li>
                <li>
                    <a href="{{ url('dashboard') }}"><i class="fi fi-rs-settings-sliders mr-10"></i>Setting</a>
                </li>
                <li>
                    <a href="{{ url('user/logout') }}"><i class="fi fi-rs-sign-out mr-10"></i>Sign out</a>
                </li>
            </ul>
                                    </div>
 ...
 <a href="{{ url('register') }}"><span class="lable ml-0">Register</span></a>
