   ...
   <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="{{ $product->id }}" onclick="productView(this.id)" ><i class="fi-rs-eye"></i></a>
    ...
    @endphp
                ...
                <div class="product-badges product-badges-position product-badges-mrg">
                    ...
                    @if($product->discount_price == NULL or $discount==0)
...
<span class="font-small text-muted">By <a href="vendor-details-1.html">Owner</a></span>
                    @else
                    <span class="font-small text-muted">By <a href="{{url('/vendor/details',$product->vendor_id )}}">{{ $product['vendor']['name'] }}</a></span>
        ...
        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
            <div class="product-img-action-wrap">
                ...
                <a aria-label="Add To Wishlist" class="action-btn" id="{{ $product->id }}" onclick="addToWishList(this.id)"  ><i class="fi-rs-heart"></i></a>
                    ...
                    <a aria-label="Quick view" class="action-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal" id="{{ $product->id }}" href="{{url('product/view/modal/',$product->id)}}"  ><i class="fi-rs-eye"></i></a>
