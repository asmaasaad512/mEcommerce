...
<form id="myForm" method="post" action="{{url('update/product') }}"  >
			@csrf
...
<div class="page-content">
	...
	<hr>
<div class="card">
<form method="post" action="{{url('update/product/thambnail') }}" enctype="multipart/form-data" >
			@csrf
...
<div class="card-body">
 ...
 <form method="post" action="{{url('update/product/multiimage') }}" enctype="multipart/form-data" >
			@csrf

	@foreach($multiImgs as $key => $img)
	<input type="hidden" name="old_img" value="{{ $img->photo_name }}">	
	...
	<a href="{{url('product/multiimg/delete',$img->id) }}" class="btn btn-danger" > Delete </a>		
		</td>
	</tr>
	@endforeach		 
