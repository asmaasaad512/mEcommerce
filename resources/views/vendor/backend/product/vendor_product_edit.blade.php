...
<form id="myForm" method="post" action="{{url('vendor/update/product') }}"  >
			@csrf
...
<div class="page-content">
	...
	<hr>
<div class="card">
<form method="post" action="{{url('vendor/update/product/thambnail') }}" enctype="multipart/form-data" >
			@csrf
...
<div class="card-body">
 ...
 <form method="post" action="{{url('vendor/update/product/multiimage') }}" enctype="multipart/form-data" >
			@csrf
	...
	<a href="{{url('vendor/product/multiimg/delete',$img->id) }}" class="btn btn-danger" id="delete" > Delete </a>		
		</td>
	</tr>
	@endforeach		 
